...
/** 寄存器地址设置 */
#define DRV8303_Status_Reg1                                 ((uint16_t)0x0000<<11)     //状态寄存器
#define DRV8303_Status_Reg2                                 ((uint16_t)0x0001<<11)
#define DRV8303_Control_Reg1                                ((uint16_t)0x0002<<11)     //控制寄存器
...
/** DRV8303使能引脚*/
#define DRV8303_EN_GATE1_GPIO_PIN                            GPIO_PIN_11
#define DRV8303_EN_GATE1_GPIO_PORT                           GPIOB
#define DRV8303_EN_GATE1_GPIO_ENABLE()                       __HAL_RCC_GPIOB_CLK_ENABLE()
...
#define  DRV8303_SPI_NSS_High()    HAL_GPIO_WritePin(GPIOA, SPI1_NSS_GPIO_PIN, GPIO_PIN_SET);
#define  DRV8303_SPI_NSS_LOW()     HAL_GPIO_WritePin(GPIOA, SPI1_NSS_GPIO_PIN, GPIO_PIN_RESET);
